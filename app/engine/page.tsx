            ...
            <AccordionContent className="pt-2 pb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-lg border border-border bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Per-tile sprite strategy for grids with elevation. Depth
                    sorting changes per rotation quadrant.
                  </p>
                </div>
                <div className="p-3 rounded-lg border border-border bg-muted/30">
                  <p className="font-semibold text-sm text-foreground mb-1">
            ...
            <AccordionContent className="pt-2 pb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-lg border border-border bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Persistent key-value storage via Playdate's datastore API.
                    Used for tokens, cached data, local settings.
                  </p>
                </div>
              </div>
            </AccordionContent>
